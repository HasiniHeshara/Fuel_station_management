  ...
  useEffect(() => {
    const fetchStock = async () => {
      try {
        ...
        setOriginalQuantity(res.data.stock.quantity);
        setOriginalType(res.data.stock.type);
      } catch (err) {
      ...
      <div className="addfuelstaff-container">
        ...
        {/*  <div className="form-group">
           ...
           <div className="form-group">
            ...
            <select name="supplier" value={stock.supplier} onChange={handleChange} required>
